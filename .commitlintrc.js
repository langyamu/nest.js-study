...
module.exports = {
  ...
  prompt: {
    ...
    scopes: [
      { value: 'Controller', name: 'Controller:    Controller 相关' },
      { value: 'Service', name: 'Service:       Service 相关' },
      { value: 'Module', name: 'Module:        Modules 相关' },
      { value: 'Entity', name: 'Entity:        Entity 相关' },
      { value: 'Test', name: 'Test:          Test 相关' },
